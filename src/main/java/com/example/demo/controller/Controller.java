...
public class Controller {
    ...
    public String halloWelt(Model model) {
        ...
        // Alle Kunden sollen zunächst in alleKunden abgespeichert werden...
        List<KundeDTO> alleKunden = kundeDao.getAllKunden();

        //TODO: uebergebe diese an das model

        // ... anschließend übergeben wir diese Variable über model.addAttribute an Thymeleaf.
        model.addAttribute("kunden", alleKunden);
    ...
    public String getFilme(Model model,
        ...
        } else if (genre != null && !genre.isEmpty() && (titel != null && titel.isEmpty())) {
        ...
        // Äquivalent Bedingung sowie Methode ergänzt
        else if (titel != null && !titel.isEmpty() && (genre != null && genre.isEmpty())) {
            filme = filmDao.getFilmeByTitel(titel);
